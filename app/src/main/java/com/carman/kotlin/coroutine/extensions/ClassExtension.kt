...
fun <VM:ViewModel> ComponentActivity.createViewModel(position:Int = 0):VM{
    val vm =  (javaClass.genericSuperclass as ParameterizedType).actualTypeArguments.filterIsInstance<Class<VM>>()
    return ViewModelUtils.createViewModelFactory(this,vm[position])
}